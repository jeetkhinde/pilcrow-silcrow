const TEMPLATE_SRC: &str = include_str!(concat!(env!("CARGO_MANIFEST_DIR"), "/pages/isr-ssg/index.html"));
const CODEBEHIND_SRC: &str = include_str!(concat!(env!("CARGO_MANIFEST_DIR"), "/pages/isr-ssg/index.rs"));
...
pub async fn bust(req: Req) -> ActionResult {
    req.cache.revalidate("/isr-ssg");
    pilcrow_web::redirect("/isr-ssg")
}
