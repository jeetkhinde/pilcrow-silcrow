...
function connectSseHub(hub) {
  ...
  es.addEventListener("live", function (e) {
    try {
      ...
      // ⚡ Bolt: Consolidate DOM queries to prevent multiple tree scans
...
function publishOptimistic(scope, data, mutationId) {
  ...
  const liveSnapshots = {};
  // ⚡ Bolt: Eliminate multiple tree scans by evaluating all live-field elements once
...
function revertOptimistic(mutationId) {
  ...
  // ⚡ Bolt: Eliminate multiple tree scans during revert
