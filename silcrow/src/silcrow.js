...
function connectSseHub(hub) {
  ...
  es.addEventListener("live", function (e) {
    try {
      ...
      // Optimize: combine [data-pilcrow-live-field] and [data-s-live-mod] into a single query
...
function publishOptimistic(scope, data, mutationId) {
  ...
  const liveSnapshots = {};
  // Optimize: single pass for all live fields instead of looping querySelectorAll
