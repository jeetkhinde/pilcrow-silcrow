...
function connectSseHub(hub) {
  ...
  es.addEventListener("live", function (e) {
    try {
      ...
      // Bolt: Optimize DOM queries - single pass over both selectors
      document.querySelectorAll("[data-pilcrow-live-field], [data-s-live-mod]").forEach(function(n) {
        ...
        if (n.hasAttribute("data-pilcrow-live-field") && Object.prototype.hasOwnProperty.call(data, k)) {
...
function publishOptimistic(scope, data, mutationId) {
  ...
  const liveSnapshots = {};
  // Bolt: Optimize DOM queries - single pass over all live fields
