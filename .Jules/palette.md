...
**Action:** When adding vanilla JS fetch handlers to forms, always consider adding a disabled state with a descriptive message ("Saving...", "Loading...") to the submit button while the network request is pending.## 2026-05-19 - Category Links Accessibility
