...
## 2026-06-06 - A11y Focus State Improvements\n**Learning:** Keyboard accessibility through focus rings and skip-links is an important part of the application for overall usability.\n**Action:** Ensure consistent use of `focus-visible:ring-2` for interactive elements and `focus-visible:outline-none` to hide default outlines and instead show the ring to clearly highlight keyboard focus. Similarly, always ensure focus states are accessible and prominent on newly added interactions like icon-only buttons.
