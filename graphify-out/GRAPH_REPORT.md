...
## Summary
- 354 nodes · 623 edges · 45 communities (25 shown, 20 thin omitted)
- Extraction: 93% EXTRACTED · 7% INFERRED · 0% AMBIGUOUS · INFERRED: 43 edges (avg confidence: 0.83)
- Token cost: 0 input · 0 output

## Community Hubs (Navigation)
- [[_COMMUNITY_Ticket Baked Page Tests|Ticket Baked Page Tests]]
- [[_COMMUNITY_Cart React Components|Cart React Components]]
- [[_COMMUNITY_Baked Declaration API|Baked Declaration API]]
- [[_COMMUNITY_Baked Page Store|Baked Page Store]]
...
- [[_COMMUNITY_Baked Pages POC|Baked Pages POC]]
- [[_COMMUNITY_Index Loaders|Index Loaders]]
- [[_COMMUNITY_Live Counter Page|Live Counter Page]]
- [[_COMMUNITY_Baked Response Headers|Baked Response Headers]]
...
### Community 0 - "Ticket Baked Page Tests"
Cohesion: 0.08
...
### Community 1 - "Cart React Components"
Cohesion: 0.05
...
### Community 2 - "Baked Declaration API"
Cohesion: 0.16
...
Cohesion: 0.14
Nodes (18): AsyncValue/AsyncHtml deferred field pattern, SSG Demo Page, SSR Demo Page, Streaming SSR Demo Page, ISR REVALIDATE constant pattern, data::counter::increment (atomic render counter), pilcrow-demos pages/deferred/index.rs, pilcrow-demos pages/isr/index.rs (+10 more)
...
### Community 16 - "Live Counter Page"
Cohesion: 0.67
Nodes (3): counter_tx(), load(), Props

### Community 18 - "Workspace Instructions"
Cohesion: 0.5
...
### Community 19 - "Admin Route Group"
Cohesion: 0.83
...
- **Why does `router()` connect `Product API Routes` to `Ticket Baked Page Tests`, `Baked Declaration API`?**
  _High betweenness centrality (0.035) - this node is a cross-community bridge._
- **Why does `BakedPageStore` connect `Baked Page Store` to `Ticket Baked Page Tests`, `Baked Declaration API`?**
  _High betweenness centrality (0.020) - this node is a cross-community bridge._
- **What connects `Props`, `Props`, `Props` to the rest of the system?**
  _84 weakly-connected nodes found - possible documentation gaps or missing edges._
- **Should `Ticket Baked Page Tests` be split into smaller, more focused modules?**
  _Cohesion score 0.08 - nodes in this community are weakly interconnected._
- **Should `Cart React Components` be split into smaller, more focused modules?**
  _Cohesion score 0.05 - nodes in this community are weakly interconnected._
- **Should `Baked Page Store` be split into smaller, more focused modules?**
