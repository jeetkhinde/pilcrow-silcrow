...
1. [AGENTS.md](file:///Users/jagjeet/Development/workspaces/pilcrow-silcrow/AGENTS.md) (workspace root) — project topology, build commands, crate map, and general instructions
2. [pilcrow/AGENTS.md](file:///Users/jagjeet/Development/workspaces/pilcrow-silcrow/pilcrow/AGENTS.md) — Pilcrow framework guidance
3. [silcrow/AGENTS.md](file:///Users/jagjeet/Development/workspaces/pilcrow-silcrow/silcrow/AGENTS.md) — Silcrow JS runtime guidance
...
### Gemini & Claude Notes
- Prefer the same MCP-first workflow described in this file.
- When instructions appear to conflict, follow `AGENTS.md` over individual agent files.
