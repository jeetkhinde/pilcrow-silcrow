...
export function buildPageHandler(module, pageMeta, layouts, config) {
...
export async function startPilcrow(adapter, config, pagesDir) {
    // 1. Discover routes
    ...
    for (const page of manifest.pages) {
        ...
        adapter.registerPage(page.pattern, page.layouts, buildPageHandler(module, page, manifest.layouts, config));
        if (module.actions) {
