...
function runTests() {
    ...
    // 1. replaces_single_slot
    {
        ...
        const slots = [['ticket_status', 'Resolved']];
    ...
    // 2. escapes_html_in_value
    {
        ...
        const slots = [['title', '<script>alert(1)</script>']];
        const result = injectFsrSlots(shell, slots);
...
runTests();
//# sourceMappingURL=baking.test.js.map